...
export function SearchBar({ value, onChange }: SearchBarProps) {
  return (
    <div className="relative">
      <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 dark:text-slate-500 light:text-slate-400" />
      <input
        type="text"
        value={value}
        ...
        className="
          ...
          placeholder:text-slate-600 dark:placeholder:text-slate-600 light:placeholder:text-slate-500
